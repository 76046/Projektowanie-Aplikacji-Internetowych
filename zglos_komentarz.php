...
<main>
    ...
    {
        $rezultat = $polaczenie->query("SELECT * FROM komentarz WHERE ID_KOMENTARZ=" . $_GET['kom']);
    ...
    else
    {
        if((isset($_SESSION['zalogowany']))&&($_SESSION['zalogowany']==true))
        {
            ...
            echo '<form method="post" action="zglos_komentarz.php?user='.$_GET['user'].'&kom='.$_GET['kom'].'&watek='.$_GET['watek'].'">';
