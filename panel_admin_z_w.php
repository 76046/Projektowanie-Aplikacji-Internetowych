                    ...
                    while($row = mysqli_fetch_array($rezultat))
                    {
                        ...
                        if(($iterator%2)==0)
                        {
                            ...
                            <tr>
                                ...
                                <td class="liczba_odwiedzin"><?php echo '<a href="profilowe.php?user='.$row['ID_ZGLASZAJACEGO'].'" target=" blank">'.$rezultat_usera['LOGIN']; ?></a></td>
                                ...
                                <td class="panel_admin">
                                    ...
                                    <a><button type="button" class="del_button" name="butt_del" title="Usuń wątek" method="post">UW</button></a>
